...
public class StudentInfoController {
	...
	public R save(StudentInfoDO studentInfoDO){
		//执行业务
		R result = studentInfoService.save(studentInfoDO);
		//响应
		return result;
	}
	...
	public R update(StudentInfoDO studentInfo){
		//执行业务
		R result = studentInfoService.update(studentInfo);
		//响应
		return result;
	}
	...
	public R remove( Integer id){
		//执行业务
		R result = studentInfoService.remove(id);
		//响应
		return result;
	}
	...
	public R remove(@RequestParam("ids[]") Integer[] ids){
		//执行业务
		R result = studentInfoService.batchRemove(ids);
		//响应
		return result;
	}
